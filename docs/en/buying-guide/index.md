...
faq:
  - q: How do I specify paprika powder?
    a: Specify the product form (sweet or low-heat paprika), target ASTA colour value (typically 60–240), heat level (under 10,000 SHU for paprika), mesh size (commonly 60–80) and moisture (under 13%).
  - q: How do I specify dried chillies?
    a: Specify the product form (whole, flakes, powder or segments), target heat level in SHU (10,000 to 50,000+), mesh for powder, and moisture. Name the variety if you have a preference.
  - q: What is the difference between paprika and chilli powder?
...
| Product | Made from | Primary job |
|---|---|---|
| Sweet paprika powder | High-colour sweet peppers (<500 SHU) | Natural red colouring |
| Low-heat paprika powder | Yidu red, Wangdu (<10,000 SHU) | Colouring + mild aroma |
| Chilli flakes / crushed | Medium-heat varieties (10,000–20,000 SHU) | Texture, mild-to-medium heat |
| Chilli powder | High-heat varieties (20,000–50,000 SHU) | Heat in sauces and seasoning |
| Whole dried chillies | Lantern, Jinta, facing-heaven, Xiaomi | Food service, visible chilli |
| Chilli segments | Extra-hot varieties (>50,000 SHU) | Extreme heat |

## Step 2: Specify Colour Value (ASTA)

Paprika is bought on colour. The ASTA colour value is the industry measure of extractable red
colour:

| Product | Typical ASTA range |
|---|---|
| Sweet paprika (Xinjiang sweet pepper) | 8–18 |
| Sweet paprika (overall supply range) | 60–240 (variety-dependent) |

Higher ASTA means more colouring power. Confirm your target value — it drives both price and
application fit. For the full explanation see
[ASTA colour & SHU explained](../asta-shu-explained/index.md).

## Step 3: Specify Heat Level (SHU)

Dried chillies are bought on heat. Chinese chilli varieties span four heat bands:

| Heat level | SHU range | Representative varieties |
|---|---|---|
| Low heat | <10,000 | Yidu red, Wangdu |
| Medium heat | 10,000–20,000 | Xian pepper, Jinta, Erjingtiao |
